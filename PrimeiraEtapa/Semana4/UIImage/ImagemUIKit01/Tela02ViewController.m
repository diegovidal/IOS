...
- (void)viewDidLoad
{
    ...
    [self.mLabelCidade setText:[NSString stringWithFormat:@"Eu moro em %@.", [[self.listaDadosPicker objectAtIndex:0] objectAtIndex:0]]];
    [self.mLabelClube setText:[NSString stringWithFormat:@"Eu me divirto em %@.", [[self.listaDadosPicker objectAtIndex:1] objectAtIndex:0]]];
}
...
-(void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    if (component == 0) {
        [self.mLabelCidade setText:[NSString stringWithFormat:@"Eu moro em %@.", [[self.listaDadosPicker objectAtIndex:component] objectAtIndex:row]]];
    }else{
        [self.mLabelClube setText:[NSString stringWithFormat:@"Eu me divirto em %@.", [[self.listaDadosPicker objectAtIndex:component] objectAtIndex:row]]];
    }
}
