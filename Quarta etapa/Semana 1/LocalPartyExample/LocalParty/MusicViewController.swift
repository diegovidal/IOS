...
//  LocalParty
//
//  Created by Eliezio Neto on 03/03/15.
...
class MusicViewController: UIViewController, UITextFieldDelegate, MCBrowserViewControllerDelegate, MCSessionDelegate, MPMediaPickerControllerDelegate, NSStreamDelegate {
    ...
    override func viewDidLoad() {
        ...
        chatView.frame = CGRectMake(5, 5, screenSize.width - 10, screenSize.height/2.5)
        chatView.editable = false
        chatView.backgroundColor = UIColor.whiteColor()
        chatView.alpha = 0.7

        
        chatTextField.frame = CGRectMake(5, chatView.frame.origin.y+chatView.frame.height+5, screenSize.width - screenSize.width/10, 30)
        ...
        chatViewBack.frame = CGRectMake(5, 5, screenSize.width - 10, screenSize.height/2.5)
        chatViewBack.backgroundColor = UIColor.whiteColor()
        let image = UIImageView(image: UIImage(named: "music-chat"))
    ...
    func textFieldShouldBeginEditing(textField: UITextField) -> Bool {
        ...
        var toolbarButtons = [item,space,item2]
